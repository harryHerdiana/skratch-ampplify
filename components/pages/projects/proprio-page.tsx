    ...
    return (
        <>
            ...
            <div className="relative bg-dark">
                ...
                <div className=" rounded-[20px] px-[9px] lg:px-[19px] bg-[url(/img/products/proprio/proprio-1-bg.png)] bg-cover bg-center bg-no-repeat overflow-hidden pb-[40px] lg:pb-[169px]">
                    <BigImageStory
